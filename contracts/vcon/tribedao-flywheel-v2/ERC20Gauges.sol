...
/** 
 ...
 @dev Volt Protocol changes after Tribe DAO's flywheel-v2 implementation:
    - Does not inherit Auth
    - Remove public addGauge(address) method 
    - Remove public removeGauge(address) method
    - Remove public replaceGauge(address, address) method
    - Remove public setMaxGauges(uint256) method
        ... Add internal _setMaxGauges(uint256) method
    - Remove public setContractExceedMaxGauges(address, bool) method
        ... Add internal _setContractExceedMaxGauges(address, bool) method
        ... Remove check of "target address has nonzero code size"
    - Remove public incrementGauge(address, uint112) method
        ... Add internal _incrementGauge(address, uint112) method
    - Remove public incrementGauges(address, uint112) method
        ... Add internal _incrementGauges(address[], uint112[]) method
    - Remove public decrementGauge(address, uint112) method
        ... Add internal _decrementGauge(address, uint112) method
    - Remove public decrementGauges(address, uint112) method
        ... Add internal _decrementGauges(address[], uint112[]) method
    - Consistency: make _incrementGauges return a uint112 instead of uint256
*/
abstract contract ERC20Gauges is ERC20 {
    ...
    */
    ...
    function _setContractExceedMaxGauges(
        address account,
        bool canExceedMax
    ) internal {
