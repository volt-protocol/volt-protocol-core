...
/**
 ...
 @dev Volt Protocol changes after Tribe DAO's flywheel-v2 implementation:
    ...
    - Remove public setMaxDelegates(uint256) method
        ... Add internal _setMaxDelegates(uint256) method
    - Remove public setContractExceedMaxDelegates(address, bool) method
        ... Add internal _setContractExceedMaxDelegates(address, bool) method
    - In _setContractExceedMaxDelegates(address, bool), remove check of "target address has nonzero code size".
 */
