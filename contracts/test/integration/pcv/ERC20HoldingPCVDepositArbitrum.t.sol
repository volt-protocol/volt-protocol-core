...
contract ERC20HoldingPCVDepositArbitrumTest is DSTest {
    Vm public constant vm = Vm(HEVM_ADDRESS);
    address payable receiver = payable(address(3));

    Core core = Core(ArbitrumAddresses.CORE);
    IERC20 weth = IERC20(ArbitrumAddresses.WETH);
    IERC20 volt = IERC20(ArbitrumAddresses.VOLT);
