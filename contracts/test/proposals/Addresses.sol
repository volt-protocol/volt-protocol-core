...
contract Addresses is Test {
    ...
    function constructAddresses() internal {
        // ---------- VOLT ADDRESSES ----------
        addMainnet("V1_CORE", 0xEC7AD284f7Ad256b64c6E69b84Eb0F48f42e8196, vm);
        addMainnet("CORE", 0xEC7AD284f7Ad256b64c6E69b84Eb0F48f42e8196, vm);
        addMainnet(
            "ERC20ALLOCATOR",
            0x37518BbE48fEaE49ECBD83F7e9C01c1A6b4c2F69,
            vm
        );
        addMainnet("GOVERNOR", 0xcBB83206698E8788F85EFbEeeCAd17e53366EBDf, vm);
        addMainnet(
            "PCV_GUARDIAN",
            0x2c2b362e6ae0F080F39b90Cb5657E5550090D6C3,
            vm
        );
        addMainnet("DEPLOYER", 0x25dCffa22EEDbF0A69F6277e24C459108c186ecB, vm);
        addMainnet(
            "VOLT_TIMELOCK",
        ...
        addMainnet("EOA_1", 0xB320e376Be6459421695F2b6B1E716AE4bc8129A, vm);
        addMainnet("EOA_2", 0xd90E9181B20D8D1B5034d9f5737804Da182039F6, vm);
        addMainnet("EOA_4", 0x6ef71cA9cD708883E129559F5edBFb9d9D5C6148, vm);
        ...
        // ---------- FEI ADDRESSES ----------
        addMainnet("FEI_CORE", 0x8d5ED43dCa8C2F7dFB20CF7b53CC7E593635d7b9, vm);
        addMainnet(
            "FEI_DAO_TIMELOCK",
        ...
        // ---------- TOKEN ADDRESSES ----------
        addMainnet("V1_VOLT", 0x559eBC30b0E58a45Cc9fF573f77EF1e5eb1b3E18, vm);
        addMainnet("VOLT", 0x559eBC30b0E58a45Cc9fF573f77EF1e5eb1b3E18, vm);
        addMainnet("USDC", 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48, vm);
        addMainnet("FEI", 0x956F47F50A910163D8BF957Cf5846D573E7f87CA, vm);
        addMainnet("DAI", 0x6B175474E89094C44Da98b954EedeAC495271d0F, vm);
        ...
        // ---------- Compound ADDRESSES ----------
        addMainnet("CDAI", 0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643, vm);
        addMainnet("CFEI", 0x7713DD9Ca933848F6819F38B8352D9A15EA73F67, vm);
        addMainnet("CUSDC", 0x39AA39c021dfbaE8faC545936693aC917d5E7563, vm);
        addMainnet("COMP", 0xc00e94Cb662C3520282E6f5717214004A7f26888, vm);
        ...
        addMainnet("GEM_JOIN", 0x0A59649758aa4d66E25f08Dd01271e891fe52199, vm);
        ...
        addMainnet("NC_PSM", 0x18f251FC3CE0Cb690F13f62213aba343657d0E72, vm);
        addMainnet("GRLM", 0x87945f59E008aDc9ed6210a8e061f009d6ace718, vm);
        addMainnet(
            "OTC_LOAN_REPAYMENT",
        ...
        // ---------- MORPHO ADDRESSES ----------
        addMainnet("MORPHO", 0x8888882f8f843896699869179fB6E4f7e3B58888, vm);
        addMainnet(
            "MORPHO_LENS",
        ...
        // ---------- MAPLE ADDRESSES ----------
        addMainnet("MPL_TOKEN", 0x33349B282065b0284d756F0577FB39c158F935e6, vm);
        addMainnet(
            "MPL_ORTHOGONAL_POOL",
