...
import {MarketGovernanceOracle} from "../../../oracle/MarketGovernanceOracle.sol";
...
contract MarketGovernanceOracleUnitTest is DSTest {
    ...
    /// @notice reference to the volt system oracle
    MarketGovernanceOracle private mgovOracle;
    ...
    /// jump up to 120% apr non compounded if liquid reserves are at 0
    uint256 public constant actualChangeRate = 1e16;
    uint256 public constant baseChangeRate = 1e16;

    /// at less than 30% liquid reserves, rate jumps
    uint256 public constant liquidityJumpTarget = 3e17;
    ...
    function setUp() public {
        ...
        mgovOracle = new MarketGovernanceOracle(
            address(core),
            baseChangeRate,
            actualChangeRate,
            liquidityJumpTarget,
        ...
        mgovOracle.setPcvOracle(address(this));
    }
    ...
    function testJumpRate() public {
        uint256 liquidPercentageAmount = 4e17;
        assertEq(
    ...
    function testCalculateRate(uint64 liquidPercentageAmount) public {
        vm.assume(liquidPercentageAmount <= 1e18);
        assertEq(
            mgovOracle.calculateRate(liquidPercentageAmount),
            mgovOracle.calculateRateLerp(liquidPercentageAmount)
        );
