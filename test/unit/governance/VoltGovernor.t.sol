...
import {VoltGovernor} from "@voltprotocol/governance/VoltGovernor.sol";
...
contract VoltGovernorUnitTest is Test {
    ...
    function setUp() public {
        ...
        core.grantRole(VoltRoles.TIMELOCK_CANCELLER, addresses.guardianAddress);
        core.createRole(VoltRoles.TIMELOCK_PROPOSER, VoltRoles.GOVERNOR);
        core.grantRole(VoltRoles.TIMELOCK_PROPOSER, address(governor));
        vm.stopPrank();
    }
